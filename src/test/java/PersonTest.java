...
public class PersonTest {
  @Rule
   ...
   public void getEmail_personInstantiatesWithEmail_String() {
     Person testPerson = new Person("Henry", "[email protected] (Links to an external site.)Links to an external site.");
     assertEquals("[email protected] (Links to an external site.)Links to an external site.", testPerson.getEmail());
   }

   @Test
    public void equals_returnsTrueIfNameAndEmailAreSame_true() {
      Person firstPerson = new Person("Henry", "[email protected] (Links to an external site.)Links to an external site.");
      Person anotherPerson = new Person("Henry", "[email protected] (Links to an external site.)Links to an external site.");
